...
public class GeoMapCluster extends StandardView {
    ...
    public void onInit(final InitEvent event) {
        ...
        List<KeyValueEntity> provinceAggregates = dataManager.loadValues(
                        "select e.province, sum(e.propertyCount) as totalProperty, avg(function('ST_X', e.coordinates)) as avgX, avg(function('ST_Y', e.coordinates)) as avgY " +
        ...
        List<KeyValueEntity> districtAggregates = dataManager.loadValues(
                        "select e.province, e.district, sum(e.propertyCount) as totalProperty, avg(function('ST_X', e.coordinates)) as avgX, avg(function('ST_Y', e.coordinates)) as avgY " +
